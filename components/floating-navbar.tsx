...
export const FloatingNavbar: React.FC<FloatingNavbarProps> = ({ navItems, className }) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "fixed top-10 left-1/2 transform -translate-x-1/2 z-50 flex gap-1 px-8 py-4 rounded-full border border-transparent bg-white/80 backdrop-blur-md shadow-lg",
        className,
      )}
    >
